...
//			if (item.getMemberAccount().equalsIgnoreCase(memberAccount)) {
//				memberUncheckOrders.add(item);
//			}
//		}
//		
//		if(!memberUncheckOrders.isEmpty()) {
//			System.out.println(memberUncheckOrders.size());
//		}
//		System.out.println(uncheckedOrders.get(0).getOrderInfo());
//		System.out.println(uncheckedOrders.size());
//	}
